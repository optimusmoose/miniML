...
public class Keys {
    ...
    public static final String SelectedAttributes = "MML_DS_CFG_ROOT_WEKA_INSTANCE_ATTRIBUTES";
    public static final String SelectedClassifier = "MML_DS_CFG_ROOT_WEKA_INSTANCE_CLASSIFIER";
